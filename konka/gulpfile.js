...
gulp.task("scss-headAndFoot", () => {
	return gulp.src("scss/headAndFoot.scss")
	.pipe(scss())
	.pipe(gulp.dest("dist/css"))
	.pipe(minify())
	.pipe(rename("headAndFoot.min.css"))
	.pipe(gulp.dest("dist/css"))
	.pipe(connect.reload());
})
...
gulp.task("build", ["copy-html", "images", "scripts", "data", "scss-index", "scss-slide", "scss-headAndFoot"], () => {
	console.log("编译成功");
})
...
gulp.task("watch", function(){
	...
	*/
	...
	gulp.watch("scss/headAndFoot.scss", ["scss-headAndFoot"])
})
